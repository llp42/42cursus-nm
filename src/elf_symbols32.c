 ...
 * them, sorts them and prints the result. Mirror of elf_symbols64.c.
 *
 ...
 */
static char get_symbol_type32(const Elf32_Sym *sym, const Elf32_Shdr *shdrs, uint16_t shnum)
{
	uint8_t bind;
	uint8_t type;
	char c;
